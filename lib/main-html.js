...
function MainHTML(props) {
  ...
  var host = 'https://s3.ap-northeast-2.amazonaws.com/apiway-resource/apiway-report'
  var clientScript = options.dev ? `http://localhost:8080/app.js` : `${host}/assets/app.js`;
  var clientStyle = options.dev ? 'http://localhost:8080/app.css' : `${host}/assets/app.css`;
